...
class UserRow(Base):
    ...
    quota_monthly_char_limit: Mapped[int | None] = mapped_column(Integer, nullable=True)
    quota_monthly_train_limit: Mapped[int | None] = mapped_column(Integer, nullable=True)
